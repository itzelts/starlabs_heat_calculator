...
const Sidebar = () => {
  return (
    <aside className="absolute top-0 left-0 right-[100%] sm:relative  bg-red-900 sm:bg-cover bg-no-repeat w-[100%] h-[100%] pt-8 sm:pl-8 sm:basis-[30%] sm:rounded-lg flex items-start justify-center sm:flex-col sm:justify-start">
      {data.map((item, idx) => {
        return (
          <div
            key={idx}
          ...
          >
            <NavLink
              style={({ isActive }) => ({
                ...
                background: isActive ? "#dda3b0" : "transparent",
